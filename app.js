...
const getPaymentDetails = (item) => [
  ...
  { label: '本次到款金额', value: formatMoney(item.amount || 0) },
  { label: '本次到款-二开利润', value: formatMoney(item.secondDevProfit || 0) },
  { label: '本次到款-实施费用', value: formatMoney(item.implementationFee || 0) },
  { label: '本次到款-二开成本', value: formatMoney(item.secondDevCost || 0) },
  { label: '本次到款-委外成本', value: formatMoney(item.outsourcingCost || 0) },
  { label: '本次到款-计划外成本', value: formatMoney(item.unplannedCost || 0) },
  { label: '本次到款-合计成本', value: formatMoney(item.totalCost || 0) },
